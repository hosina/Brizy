...
class Brizy_Public_EditorBuild_179Beta1Wp_Texts {
	public static function get_editor_texts() {
		return apply_filters('brizy_editor_config_texts', array(
			...
			"Custom image" => __("Custom image", "brizy"),
			"Custom link" => __("Custom link", "brizy"),
			...
			"Something went wrong with the" => __("Something went wrong with the", "brizy"),
			...
			"Tada" => __("Tada", "brizy"),
			"Tags" => __("Tags", "brizy"),
			"Tags filter" => __("Tags filter", "brizy"),
			"Tail" => __("Tail", "brizy"),
